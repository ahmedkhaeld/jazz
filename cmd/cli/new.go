...
func startNew(appName string) {
	...
	_, err := git.PlainClone("./"+appName, false, &git.CloneOptions{
		URL:      "https://github.com/ahmedkhaeld/jazz-app.git",
		Progress: os.Stdout,
		Depth:    1,
	})
	if err != nil {
	...
	env = strings.ReplaceAll(env, "${KEY}", jz.RandomString(32))
...
func updateSource() {
	//walk the current directory including subdirectories
